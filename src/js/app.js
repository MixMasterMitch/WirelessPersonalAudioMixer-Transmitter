var app = angular.module('WirelessPersonalAudioMixerTransmitter', ['ui.bootstrap-slider']);

app.run(function($rootScope, shortid, receiverDiscovery, controlApiServerFactory) {
